...
public class CipherView {
    ...
    private Button encryptButton = new Button("Verschlüsseln");
    private Button decryptButton = new Button("Entschlüsseln");
    private Button fileButton = new Button("Pad File einfügen");
